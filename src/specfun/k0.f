...
C
C     BESK0(ARG)   0 < ARG <= XMAX       K0(ARG)           1
C     BESEK0(ARG)     0 < ARG           EXP(ARG)*K0(ARG)     2
C
...
C  BESK0 entry returns the value 0.0 for ARG > XMAX.
C
C
...
C   for arguments 0.0 < ARG <= XMAX (see comments heading
C   CALCK0).
C
C  Authors: W. J. Cody and Laura Stoltz
C
